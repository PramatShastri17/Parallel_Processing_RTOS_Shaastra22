/*
 * Semaphore - Demonstrate a counting semaphore by creating several tasks with the same parameters.
 */
...
void setup() {
  ...
  // Create a counting semaphore (initilize at 0)
  ...
  // Show that we created all the tasks
